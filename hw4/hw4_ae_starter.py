...
class Autoencoder(nn.Module):
    ...
    def calc_bce_loss(self, xbin_ND):
        ...
        Returns
        -------
        per_pixel_bce : scalar
            Binary cross-entropy, *averaged* over all pixels in all images
        ...
        xproba_ND = xbin_ND # TODO FIXME
        per_pixel_bce = torch.sum(self.decoder_params[-1].weight) # TODO FIXME
        return per_pixel_bce, xproba_ND
